...
This repository contains the article data: _Estimating parties’ policy positions in Uruguay: comparing scaling methods based on legislative speeches and roll-call votes_. Additionally, in this repository you will find the replication files and additional material.
